...
st.write("""
    [![ver código fuente](https://img.shields.io/badge/Repositorio%20GitHub-gris?logo=github)](https://github.com/bladealex9848/ColDisBot)
    ![Visitantes](https://api.visitorbadge.io/api/visitors?path=https%3A%2F%2Fcoldisbot.streamlit.app&label=Visitantes&labelColor=%235d5d5d&countColor=%231e7ebf&style=flat)
    """)
